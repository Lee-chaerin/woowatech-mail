...
const CsList = () => {
  ...
  const { data: pageData, isLoading } = useGetPagePosts(CATEGORY_ID.CS, currentPage);
  ...
  return (
    <div className="relative">
      <div className="relative h-80">
        <img src="/background_cs.jpg" alt="cs 배경" className="absolute inset-0 w-full h-full object-cover z-0" />
